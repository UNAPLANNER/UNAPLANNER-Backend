...
public interface ICurriculumService
{
    ...
    Task<(bool Success, StudentCourseProgressResponse? Course, string? ErrorMessage)> UpdateCourseStatusAsync(int studentId, int courseId, UpdateCourseStatusRequest request);
}
